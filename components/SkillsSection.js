                ...
                <div className="text-center shadow-lg p-8 rounded-xl my-6 dark:bg-white flex-1">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="col-span-2">
                            ...
                            <ul>
                                {['Software Application Testing', 'Software Documentation Control', 'Performance Evaluation and Optimization', 'Scrum', 'Agile', 'SOLID Principles', 'Design Patterns'].map((tool) => (
                                    <li className="text-gray-800 py-1" key={tool}>{tool}</li>
                                ))}
                            </ul>
                        </div>
